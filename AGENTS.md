...
- Participants run as standard read-write CLI calls — exactly like running the CLI yourself: they can read, edit files, and run commands. `effectiveToolsPolicy` (workflows.js) defaults to `workspace-write` (confined to the project workspace).
