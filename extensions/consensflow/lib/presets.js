...
export const PARTICIPANT_PRESETS = [
  ...
  // Opus 4.8 on OpenCode (via OpenRouter; note the dotted 4.8 id on OpenRouter).
  {
    ...
    id: "baldr",
    name: "Baldr",
    label: "OpenCode Opus 4.8 MAX",
    description: "OpenCode-backed Claude Opus 4.8 at max variant (via OpenRouter).",
    kind: "opencode",
  ...
  },
  {
    ...
    description: "Swift, cheap OpenCode-backed Gemini 3.5 Flash (via OpenRouter).",
    kind: "opencode",
    model: "openrouter/google/gemini-3.5-flash",
    roles: ["reviewer"],
    toolsPolicy: "readonly",
